...
func (ec *executionContext) _Entity_findResourceByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNResource2ᚖgithubᚗcomᚋKORSᚑlsᚋtmsᚑkmᚋinternalᚋgraphᚋmodelᚐResource,
		true,
		true,
	)
}
...
func (ec *executionContext) _Query_tools(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNResource2ᚕᚖgithubᚗcomᚋKORSᚑlsᚋtmsᚑkmᚋinternalᚋgraphᚋmodelᚐResourceᚄ,
		true,
		true,
	)
}
...
func (ec *executionContext) marshalNResource2githubᚗcomᚋKORSᚑlsᚋtmsᚑkmᚋinternalᚋgraphᚋmodelᚐResource(ctx context.Context, sel ast.SelectionSet, v model.Resource) graphql.Marshaler {
	return ec._Resource(ctx, sel, &v)
}

func (ec *executionContext) marshalNResource2ᚕᚖgithubᚗcomᚋKORSᚑlsᚋtmsᚑkmᚋinternalᚋgraphᚋmodelᚐResourceᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Resource) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNResource2ᚖgithubᚗcomᚋKORSᚑlsᚋtmsᚑkmᚋinternalᚋgraphᚋmodelᚐResource(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNResource2ᚖgithubᚗcomᚋKORSᚑlsᚋtmsᚑkmᚋinternalᚋgraphᚋmodelᚐResource(ctx context.Context, sel ast.SelectionSet, v *model.Resource) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
